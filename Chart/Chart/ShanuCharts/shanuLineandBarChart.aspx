<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shanuLineandBarChart.aspx.cs" Inherits="Chart.ShanuCharts.shanuLineandBarChart" MasterPageFile="~/Site.master"  %>
            ...
            if (m) {
                if (navigator.appName == 'Microsoft Internet Explorer') {
                    ...
                    $.ajax({
                        ...
                        url: 'shanuLineandBarChart.aspx/SaveImage',
                    ...
                    <table  width="100%" >
                     <tr>
                        <td class="style1" align=left>
                         ...
                         <tr>
                         <td >
                         <h2 style="color:#465c71;"><b>Line and Bar Chart</b></h2>
                         </td>
                         </tr>
                         </table>
                        </td>
...
onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;" >7</asp:TextBox><br />
   ...
   <img src="../images/lineBar.png"  onClick="drawChart()" alt="Click to Draw PIE Chart" />
                   </td>
     ...
     <img src="../images/Save.png"  onClick="ShanuSaveImage()" alt="Click to Save PIE Chart" />
        ...
        <asp:TextBox ID="txtTitle" runat="server" Height="26px" MaxLength="40" Width="140px" >Line &amp; Bar Chart</asp:TextBox><br />
                 </td>
                                 <td  style="background-color:#ECF3F4;border-right:1px solid #C7C7C7;" >
                                     Chart WaterMark:
